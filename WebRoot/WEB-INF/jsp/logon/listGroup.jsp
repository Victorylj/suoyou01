...
<script type="text/javascript" src="js/logon/listGroup.js"></script>
...
<body>
	...
	<div class="rightinfo">
		<div class="tools">
			<ul class="seachform">
				<form id="searcherForm" action="listGroup.do" method="post" onsubmit="initshow()">
				...
				<c:choose>
					<c:when test="${not empty page.list}">
						<c:forEach items="${page.list}" var="v" varStatus="var">
							...
							<tr>
								<td>${ v.group_id}</td>
								<td  style="display:none;">${v.parent_id }</td>
								<td>${v.group_name }</td>
								
								<td>
								<a href="editGroup.do?group_id=${v.group_id }" class="tablelink">修改</a>
								 <a href="javascript:void()" onclick="deleteGroup(${ v.group_id})" class="tablelink" style="display:none;"> 删除</a></td>
							</tr>
