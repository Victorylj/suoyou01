...
<script type="text/javascript" src="js/logon/listModule.js"></script>
...
<body>
	...
	<div class="rightinfo">
		<div class="tools">
			<ul class="seachform">
				<form id="searcherForm" action="listModule.do" method="post" onsubmit="initshow()">
					...
					<c:when test="${not empty page.list}">
						<c:forEach items="${page.list}" var="v" varStatus="var">
							...
							<tr>
								...
								<td>								
								<a href="editModule.do?module_id=${v.module_id }" class="tablelink">修改</a>
								<a href="editModule.do?parent_id=${v.module_id }&module_name=${v.module_name}" class="tablelink">添加子模块</a>
								 <a href="javascript:void()" onclick="deleteModule(${ v.module_id})" class="tablelink"> 删除</a></td>
							</tr>
