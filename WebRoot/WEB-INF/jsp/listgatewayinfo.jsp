				...
				<div class="pop-box-body">
					...
					<div id="tab1" class="tabcontent">
						...
						<div  class="form_row" >
								<label>开通省份:</label>
								<label>
 								<input type="checkbox" name="province" value="10" onclick=";">北京
			                    <input type="checkbox" name="province" value="20" onclick=";">广东
			                    <input type="checkbox" name="province" value="21" onclick="checkboxChange();">上海
			                    <input type="checkbox" name="province" value="22" onclick="checkboxChange();">天津
			                    <input type="checkbox" name="province" value="23" onclick="checkboxChange();">重庆
			                    <input type="checkbox" name="province" value="24" onclick="checkboxChange();">辽宁
			                    <input type="checkbox" name="province" value="25" onclick="checkboxChange();">江苏
			                    <input type="checkbox" name="province" value="27" onclick="checkboxChange();">湖北
			                    <input type="checkbox" name="province" value="28" onclick="checkboxChange();">四川
			                    <input type="checkbox" name="province" value="29" onclick="checkboxChange();">陕西
			                    <input type="checkbox" name="province" value="311" onclick="checkboxChange();">河北
			                    <input type="checkbox" name="province" value="351" onclick="checkboxChange();">山西
			                    <input type="checkbox" name="province" value="371" onclick="checkboxChange();">河南    
			                    <input type="checkbox" name="province" value="431" onclick="checkboxChange();">吉林

			                    <input type="checkbox" name="province" value="531" onclick="checkboxChange();">山东
			                    <input type="checkbox" name="province" value="551" onclick="checkboxChange();">安徽
			                    <input type="checkbox" name="province" value="571" onclick="checkboxChange();">浙江
			                    <input type="checkbox" name="province" value="591" onclick="checkboxChange();">福建
			                    <input type="checkbox" name="province" value="731" onclick="checkboxChange();">湖南
			                    <input type="checkbox" name="province" value="771" onclick="checkboxChange();">广西
			                    <input type="checkbox" name="province" value="791" onclick="checkboxChange();">江西
			                    <input type="checkbox" name="province" value="851" onclick="checkboxChange();">贵州
			                    <input type="checkbox" name="province" value="871" onclick="checkboxChange();">云南   
			                    <input type="checkbox" name="province" value="891" onclick="checkboxChange();">西藏
			                    <input type="checkbox" name="province" value="898" onclick="checkboxChange();">海南
			                    <input type="checkbox" name="province" value="931" onclick="checkboxChange();">甘肃
			                    <input type="checkbox" name="province" value="951" onclick="checkboxChange();">宁夏
			                    <input type="checkbox" name="province" value="971" onclick="checkboxChange();">青海
			                    <input type="checkbox" name="province" value="991" onclick="checkboxChange();">新疆
								
								<input type="checkbox" name="province" value="451" onclick="checkboxChange();">黑龙江
			                    <input type="checkbox" name="province" value="471" onclick="checkboxChange();">内蒙古
								<input type="checkbox" name="province" value="0" onclick="checkboxChange();">其它
