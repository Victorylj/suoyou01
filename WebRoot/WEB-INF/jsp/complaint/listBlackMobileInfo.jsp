...
$(function(){
	 ...
	 $("#searchSp").searchInit({searchObj:"searchSp", searchText: "cp_name", searchId: "cp_id", result:"result", searchUrl: "/seachNewCpCompanyList.do",cascade:cascade});
	 $("#searchCode").searchInit({searchObj:"searchCode", pid:"cp_id", searchText: "product_name", searchId: "product_id", result:"result1", searchUrl: "/seachNewCpProductList.do"});
...
<body>
	...
	<div class="rightinfo">
		<div class="tools">
		<form id="searcherForm" action="listBlackMobileInfo.do" method="post" onsubmit="initshow()">
			<ul class="seachform">
				...
				<li><label>手机号码</label><input name="mobile" type="text"
						class="scinput" value="${searchObj.mobile}"/></li>
				<li><label>IMSI</label><input name="imsi" type="text"
