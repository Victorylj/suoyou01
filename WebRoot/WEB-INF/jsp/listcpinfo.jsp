		...
		<div class="center_content">
			<div id="right_wrap">
				<div id="right_content">
					...
					<form id="searcherForm" action="listCpInfo.do" method="post">
					<div id="search_form" class="search">
						<div class="search_form">
							<div class="search_form_row">
								<label>CP名称:</label> <input type="text" class="search_form_input"
									name="cp_name" />
							</div>
							<div class="search_form_row">
								<label>CP编号:</label> <input type="text" class="search_form_input"
									name="id" />
							</div>
						</div>	
									...
									<c:forEach items="${page.list}" var="v" varStatus="var">
										...
										<tr class="odd">
											...
											<td><a href="#"><img src="images/edit.png" alt=""
													title="" border="0" /></a></td>
											<td><a href="javascript:void(0);" onclick="deleteCpInfo(${ v.id})"><img src="images/trash.gif" alt=""
													title="" border="0" /></a></td>
										</tr>
			...
			<div id='pop-div' class="pop-box"
				...
				<div class="pop-box-body">
					...
					<div id="tab1" class="tabcontent">
						...
						<form action="addCpInfo.do" method="post">
							<div class="form">
								<div class="form_row">
								...
								<div class="form_row">
									<label>CP地址:</label> <input type="text" class="form_input"
										name="cp_address" />
								</div>
								<div class="form_row">
									<label>上行URL:</label> <input type="text" class="form_input"
										name="mo_url" />
								</div>
								<div class="form_row">
									<label>下行URL:</label> <input type="text" class="form_input"
										name="mr_url" />
								</div>
