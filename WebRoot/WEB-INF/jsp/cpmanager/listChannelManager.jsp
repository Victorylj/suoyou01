...
<script type="text/javascript" src="js/cpmanager/listChannelManager.js"></script>
...
<body>
	...
	<div class="rightinfo">
		<div class="tools">
			<ul class="seachform">
				<form id="searcherForm" action="listChannelData.do" method="post" onsubmit="initshow()">
				<li><label>负责人名称</label><input name="m_name" type="text"
						class="scinput" /></li>
				...
				<c:choose>
					<c:when test="${not empty page.list}">
						<c:forEach items="${page.list}" var="v" varStatus="var">
							...
							<tr>
								<td><input type="checkbox" name="ch_id" value="${ v.m_id}" /></td>
								<td>${v.m_name }</td>
								<td>${v.create_time }</td>

								<td><a
									href="editChannelManager.do?m_id=${v.m_id }"
									class="tablelink">修改</a> <a href="javascript:void()"
									onclick="deleteChannelManager(${ v.m_id})" class="tablelink">
										删除</a></td>
							</tr>
