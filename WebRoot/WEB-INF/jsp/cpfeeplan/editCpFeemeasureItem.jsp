...
<body>
    ...
    <form action="updateCpFeemeasureItem.do" method="post">
    <ul class="forminfo">
    <c:if test="${paramObj.feemeasure_item_id >0 }">
						<li><input name="feemeasure_id" value="${paramObj.feemeasure_id }"
							type="hidden"></input> <label>扣费方案</label><input
							name="feemeasure_name" value="${paramObj.feemeasure_name }" type="text"
    ...
    <li>
    <input name="feemeasure_item_id" value="${paramObj.feemeasure_item_id }" type="hidden" ></input>
    <input name="feemeasure_id" value="${paramObj.feemeasure_id }" type="hidden" ></input>
    <label>措施名称</label><input name="feemeasure_name"  value="${paramObj.feemeasure_name }" type="text" class="dfinput" /><i></i>
    </li>
    <li>
